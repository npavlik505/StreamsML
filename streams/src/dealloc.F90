...
#ifdef USE_CUDA
if (allocated(w_avzg_gpu)) deallocate(w_avzg_gpu)
#endif
...
if (allocated(uoverslot)) deallocate(uoverslot)
...
if (allocated(w_avz_gpu)) deallocate(w_avz_gpu)
if (allocated(w_avzg_gpu)) deallocate(w_avzg_gpu)
...
if (allocated(tauw_x_gpu)) deallocate(tauw_x_gpu)
